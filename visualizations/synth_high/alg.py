...
def render(code):
    ...
    html_page_sunburst = """
            ...
            <pre class="prettyprint lang-java mycode">""" + code.replace("\t", "    ") + """    </pre>
        </html>"""
    html_page = """
        <!DOCTYPE html><html>
        <script src="https://cdn.jsdelivr.net/gh/google/code-prettify@master/loader/run_prettify.js"></script>
...
if __name__ == "__main__":
    from_to_file("<path>/visualizations/example.java", "<path>/visualizations/example_color_high.png") # Path must be set
